...
For projector "2" commitment and storage mechanics, see [ADR 0025](../decisions/0025-incremental-result-commitment.md).
...
For current supported database version selection and incremental storage, see [ADR 0025 §5](../decisions/0025-incremental-result-commitment.md#5-incremental-representation-and-atomic-publication), superseding ADR 0017's selection. The DDL excerpt below does not enumerate the later projector tables; consult the accepted ADR and [shipped schema](../schema.sql).
